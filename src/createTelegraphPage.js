...
const createTelegraphPage = async (title, authorName, authorUrl, summary, content, imageUrl) => {
  ...
  try {
    const response = await axios.post('https://api.telegra.ph/createPage', {
      ...
      content: JSON.stringify([
        { tag: 'img', attrs: { src: imageUrl, alt: '', class: 'photoModule__visual', itemprop: 'contentUrl url' } },
